...
public class ProductListAdapter extends ArrayAdapter<Product> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //new ImageDownloader(imgProductLogo, getContext()).execute(product.getStrImageUrl());
        new ImageDownloader(imgProductLogo, getContext(), product.getIntId()).execute(product.getStrImageUrl());

        //txtProductDescription.setText(product.getStrName() +" - " + product.getStrShortDescription());
        txtProductDescription.setText(product.getStrName());
